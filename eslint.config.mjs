// scaffold-linter: ts sha256:8dd8b84394a7
...
export default tseslint.config(
  {
    ignores: [
      ...
      'lib/linters/**',
      'tools/**',
      // scaffold-vendored TS scripts — maintained & type-linted upstream; not
      // part of this repo's tsconfig program, so projectService can't type them.
      'scripts/**',
      '**/*.scaffold-new',
